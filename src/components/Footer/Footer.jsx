        ...
        <footer>
            <div id="footer-div">
                <div id="footer-logo">
                    ...
                    <div id="footer-frase">Siga o Receiba</div>
                    <div id="footer-sociais">
                        ...
                        >
                            <path
                                d="M7.50088 0L2.14374 5.35714V24.6429H8.57231V30L13.9295 24.6429H18.2152L27.858 15V0H7.50088ZM25.7152 13.9286L21.4295 18.2143H17.1437L13.3937 21.9643V18.2143H8.57231V2.14286H25.7152V13.9286Z"
                                fill="#C4C4C4"
                            />
                            <path
                                d="M22.5009 5.89282H20.358V12.3214H22.5009V5.89282Z"
                                fill="#C4C4C4"
                            />
                            <path
                                d="M16.608 5.89282H14.4651V12.3214H16.608V5.89282Z"
                                fill="#C4C4C4"
                            />
                        </svg>
                        <svg
